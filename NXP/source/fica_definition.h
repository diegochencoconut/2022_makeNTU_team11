...
#define FICA_FILE_SYS_FILE_COUNT 32

#else
/* FLASH_SIZE >= 32MB */
#define FICA_IMG_RESERVED_SIZE   0x00100000 /* 1  MB - toolbox - deprecated */
#define FICA_IMG_APP_A_SIZE      0x00A00000 /* 10 MB */
#define FICA_IMG_APP_B_SIZE      0x00A00000 /* 10 MB */
#define FICA_FILE_SYS_FILE_COUNT 32
#endif

#define FICA_FILE_SYS_SIZE      (SECTOR_SIZE * FICA_FILE_SYS_FILE_COUNT)
#define FICA_CRYPTO_BACKUP_SIZE (SECTOR_SIZE)
#define FICA_TABLE_SIZE         (SECTOR_SIZE)
