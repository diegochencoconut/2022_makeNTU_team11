...
#define SLN_FLASH_MGMT_BASE_ADDR    (FICA_IMG_FILE_SYS_ADDR)
#define SLN_FLASH_MGMT_LAST_ADDR    (FICA_IMG_FILE_SYS_ADDR + FICA_FILE_SYS_SIZE)
#define SLN_FLASH_MGMT_SIZE_BYTES   (FICA_FILE_SYS_SIZE)
...
#define SLN_FLASH_MAX_MAP_ENTRIES    ((SECTOR_SIZE / FLASH_PAGE_SIZE) - 1)
