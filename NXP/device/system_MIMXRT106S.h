 ...
 * @version 1.2
 * @date 2019-04-29
 * @brief Device specific configuration file for MIMXRT106S (header file)
 *
...
#ifndef _SYSTEM_MIMXRT106S_H_
#define _SYSTEM_MIMXRT106S_H_                    /**< Symbol preventing repeated inclusion */
